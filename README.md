...
`React` `Flask` `PostgreSQL` `SQLAlchemy` `JWT` `AWS S3` `Tailwind CSS`

### [TouchBase](https://touchbaseforensics.com) : Fingerprint Examiner Certification Platform
A forensics platform that certifies fingerprint examiners on real performance data instead of a one-time exam. Examiners work through verified comparison sessions across three core skills, the system measures their accuracy and error rates, and a five-level credential reflects not just what they've done but how they're performing now.

`React` `Flask` `PostgreSQL` `SQLAlchemy` `OpenCV` `NumPy` `WebAuthn`

### [DOCUTHING](https://dader34.github.io/DOCUTHING) : Client-Side PDF Editor & Toolkit
...
- **Portfolio:** [dader34.github.io/portfolio](https://dader34.github.io/portfolio/)

Feel free to explore these projects and let me know your thoughts!

## Let's Connect
I'm always open to collaboration and discussion. If you have similar interests or have a project in mind, don't wait to reach out.
