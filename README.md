...
### [TouchBase](https://touchbaseforensics.com)   Collaborative Communication Platform
Team collaboration and communication platform with drag-and-drop queue management, real-time notifications, and modular architecture spanning separate frontend, backend, and demo applications.

`React` `Node.js` `Express` `React DnD`
